...
## 更新日志
 ...
 #### 2026/2/5 V1.3.26.86
	...
	3. 修正tooltip功能
	4. 修正触屏事件
 #### 2026/1/11 V1.3.26.85
  	1. 【!】优化CheckedListBox（旧版有可能导致反应缓慢）
	2. 优化ListView，增加列宽拖拉功能
	3. 【!】支持Aot编译，请注意有大量程序修改
 #### 2025/12/24 V1.3.26.84
 	1. 【!】修改DataGridView核心功能、属性
	2. 更新ComboBox
	3. 增加实现Screen类库
	4. 完善Graphics绘制字符串方法
	5. 【!】优化容器布局程序，更精确的Dock\Anchor动态布局功能
	6. 修正一些基础功能
