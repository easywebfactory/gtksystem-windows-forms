...
namespace System.Windows.Forms
{
    ...
    public partial class RichTextBox : WidgetControl<Gtk.TextView>
    {
        ...
        {
            add { base.Control.Buffer.Changed += (object o, EventArgs args) => { value.Invoke(o, args); }; }
            remove { base.Control.Buffer.Changed -= (object o, EventArgs args) => { value.Invoke(o, args); }; }
        }
