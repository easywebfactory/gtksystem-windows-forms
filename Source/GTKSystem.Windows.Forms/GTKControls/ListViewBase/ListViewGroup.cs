...
namespace System.Windows.Forms
{
    public sealed class ListViewGroup : ISerializable
    {
        ...
        internal readonly Gtk.FlowBox FlowBox = new Gtk.FlowBox()
            { Orientation = Gtk.Orientation.Horizontal, Name = Guid.NewGuid().ToString() };
        ...
        public ListViewGroupCollapsedState CollapsedState { get; set; }
