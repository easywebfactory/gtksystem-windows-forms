...
namespace System.Windows.Forms
{
    ...
    public partial class NumericUpDown : WidgetControl<Gtk.SpinButton>
    {
        ...
        {
            add { base.Control.ValueChanged += (object sender, EventArgs e) => { value.Invoke(sender, e); }; }
            remove { base.Control.ValueChanged -= (object sender, EventArgs e) => { value.Invoke(sender, e); }; }
        }
