...
namespace System.Windows.Forms
{
    ...
    public partial class MonthCalendar : WidgetControl<Gtk.Calendar>
    {
        ...
        {
            if (DateChanged != null)
                DateChanged(sender, new DateRangeEventArgs(SelectionRange.Start, SelectionRange.End));

            if (DateSelected != null)
                DateSelected(sender, new DateRangeEventArgs(SelectionRange.Start, SelectionRange.End));
        }
